...
- 砥石から同じ魔石のTierを消費し、刻印をリロールできる機能
...
- エリートmobのドロップにお楽しみメモリスターRank2EXを追加

- エリートmobの攻撃力にキャップを設け、500Lv以上の攻撃力にならないように下方修正
...
- ダウジングスポナーを発動する際、50m以内の最も近いスポナーを5秒間発光させる効果を追加
