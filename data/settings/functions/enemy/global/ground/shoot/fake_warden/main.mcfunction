...
# 追加： ルートテーブルをお楽しみt3に
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable append value {Loot:"item:item/carrot_on_a_stick/enjoy_memory_star_rank2",Count:1,Chance:1.0d}
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable append value {Loot:"item:item/carrot_on_a_stick/secret_exp_bug_memory_star",Count:1,Chance:1.0d}
