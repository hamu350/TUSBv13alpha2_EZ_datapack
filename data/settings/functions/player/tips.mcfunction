...
data modify storage tusb_player: EZ_TIPS append value '[{"with":[{"translate":"一部のスキルは攻撃範囲や火力、効果量が変わっています。途中導入した場合、スキルを付けなおすことで変更が適応されます。","color":"white","italic":false,"color":"green"}],"translate":"[EZ_TIPS] %1$s","bold":true,"color":"green"},{"translate":"➡このEZ_TIPSを表示しない","clickEvent":{"action":"run_command","value":"/trigger EZTipsSupTrigger set 15"}}]'
...
data modify storage tusb_player: EZ_TIPS append value '[{"with":[{"translate":"途中導入した場合、導入するまでに手に入れた刻印付きアイテムで砥石を使うことはできません！","color":"white","italic":false,"color":"green"}],"translate":"[EZ_TIPS] %1$s","bold":true,"color":"green"},{"translate":"➡このEZ_TIPSを表示しない","clickEvent":{"action":"run_command","value":"/trigger EZTipsSupTrigger set 23"}}]'
